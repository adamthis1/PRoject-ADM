...
<div style="background-image:  linear-gradient(to bottom left, aqua, blue)">
        ...
        <div class="login-page">
            <div class="form">
                ...
                <form method="POST">
                    ...
                    <p>Nomor Telepon :</p>
                    <input type="tel" name="nomorTelepon" placeholder="Masukkan No Telepon" pattern=".{10,14}" required>
                    <p>Password :</p>
