...
<head>
    <title>Dashboard Admin - Triwira88Laundry</title>
    <script src="js/jquery-3.5.1.js"></script>
    <script src="bootstrap/js/bootstrap.bundle.js"></script>
    <script src="bootstrap/jquery.dataTables.min.js"></script>
    <script src="bootstrap/dataTables.bootstrap4.min.js"></script>
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD2VtG22tEEfSw-KA850vyuWzL5xAvS4-U"></script>
...
<body>
    <!-- Navbar -->
    <nav id="navbar-admin" class="navbar fixed-top navbar navbar-expand-lg navbar-dark bg-primary">
        <a class="navbar-brand" href="admin_dash.php"><b style="font-family: cambria;">Triwira88Laundry</b></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active">
                    <button style="background-color: black;"><a class="nav-link" href="logout.php">Logout</a></button>
                </li>
            </ul>
        </div>
    </nav>
    ...
    <div data-spy="scroll" data-target="#navbar-admin" data-offset="0">
        <div class="jumbotron jumbotron-fluid">
            <div class="container">
                <br>
                <h1 id="beranda" class="display-5" style="font-family: cambria;">Selamat datang, <?php echo $_SESSION['name']; ?>!</h1>
                <br>
                <p class="lead" style="font-family: cambria;">Anda berada di ruang admin, cek pesanan dan profil pelanggan disini.</p>
            </div>
        </div>
        <div class="jumbotron jumbotron-fluid bg-white">
            <div class="container">
                <h1 class="tengah" id="statistik" style="font-family: cambria;">Statistik</h1>
                <p class="tengah" style="font-family: cambria;">Melihat berapa banyak pesanan dan pelanggan yang terdaftar.
                </p>
                <br>
                <div class="row">
                    <div class="col-6">
                        <div class="tengah">
                            <h3 style="font-family: cambria;">Pesanan</h3>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="tengah">
                            <h3 style="font-family: cambria;">Pelanggan</h3>
                        </div>
                    </div>
                </div>
                <br>
                <div class="row">
                    <div class="col-6">
                        <div class="tengah"><img src="images/pesnann.png" width="150px" height="130px"></div>
                    </div>
                    <div class="col-6">
                        <div class="tengah"><img src="images/pelaggan.png" width="150px"></div>
                    </div>
                </div>
                <br>
                <div class="row">
                    <div class="col-6">
                        <div class="tengah">
                            <h5 style="font-family: cambria;"><?php echo $banyakpesanan ?> pesanan</h5>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="tengah">
                            <h5 style="font-family: cambria;"><?php echo $banyakdata; ?> pelanggan</h5>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="jumbotron jumbotron-fluid bg-light">
            <div class="container">
                <h1 class="tengah" id="pesanan" style="font-family: cambria;">Pesanan</h1>
                <p class="tengah" style="font-family: cambria;">Daftar pesanan dari pelanggan.
                </p>
                <br>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="admin_dash.php?view=<?php echo $order['id']; ?>#pesanan" method="post">
                                        ...
                                        <input type="submit" class="btn btn-warning btn-sm" value="View" name="view">
                                    </form>
                                </td>
                            </tr>
                        <?php
                ...
                if ($view_order == false) {
                    ...
                    <p class="tengah">
                        <input type="submit" class="btn btn-info btn-sm" name="update_order" value="Update" />
                        <input type="submit" class="btn btn-success btn-sm" name="cancel_update" value="Cancel" />
                    </p>
                    </form>
                <?php
                }
        ...
        <div class="jumbotron jumbotron-fluid bg-white">
            <div class="container">
                <h1 class="tengah" id="customers" style="font-family: cambria;">Profil Pelanggan</h1>
                <p class="tengah" style="font-family: cambria;">Daftar pelanggan yang terdaftar.
                </p>
                <br>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <form method="post" onsubmit="return confirm('Anda yakin ingin menghapus pelanggan ini?');">
                                        <input type="hidden" name="id" value="<?= $row['id'] ?>">
            ...
            if ($edit_form == false) {
                ...
                <?php
                    ...
                    <p class="tengah"><input type="submit" class="btn btn-info btn-sm" name="update" value="Update" />
                        <input type="submit" class="btn btn-warning btn-sm" name="cancel" value="Cancel" />
                    </p>
                </form>
            <?php
                } ?>
    ...
    <footer class="page-footer font-small blue">
        <div class="footer-copyright text-center py-3 bg-dark text-white">© 2023 Copyright:
            <a href="#"> Laundry OnLine Triwira88</a>
        </div>
    </footer>
